...
export const ResetPassword = ({ password, confirmPassword, onPasswordChange, onConfirmPasswordChange, loading, onSubmit, onBack, error, successMessage, accentColor }) => (
  <View style={styles.card}>
    ...
    <View style={styles.header}>
      ...
      <Text style={styles.subtitle}>Choose a strong password you can remember.</Text>
    </View>
    ...
    <View style={styles.inputGroup}>
      ...
      <View style={styles.inputWrapper}>
        ...
        <TextInput style={styles.input} value={password} onChangeText={onPasswordChange} placeholder="Enter new password" placeholderTextColor="#94a3b8" secureTextEntry editable={!loading} />
      </View>
    </View>
    ...
    <View style={styles.inputGroup}>
      ...
      <View style={styles.inputWrapper}>
        <Feather name="lock" size={18} color="#94a3b8" style={styles.inputIcon} />
        <TextInput style={styles.input} value={confirmPassword} onChangeText={onConfirmPasswordChange} placeholder="Confirm new password" placeholderTextColor="#94a3b8" secureTextEntry editable={!loading} />
      </View>
    </View>
