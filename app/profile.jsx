...
const Profile = () => {
  ...
  const addressFormatted =
    typeof user?.address === "object" && user.address !== null
      ...
      : user?.address || "";
  const licenseNo =
    user?.licenseNumber || user?.drugLicenseNo || user?.druglicenseNo || null;
  const licenseImg = normalizeImageUrl(
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          {!user ? (
            <View style={styles.notLoggedInBox}>
              ...
              <TouchableOpacity
                onPress={() => router.push("/Stockist/stockist-login")}
              >
                <Text style={styles.notLoggedInLink}>
              ...
              <View style={styles.card}>
                ...
                <View style={styles.verticalInfoList}>
                  ...
                  >
                    ...
                    {licenseNo ? (
                      <Text style={[styles.infoBoxValue, styles.monoText]}>
                        {licenseNo}
                      </Text>
                    ) : (
                      <Text style={[styles.infoBoxValue, { color: "#9ca3af" }]}>
                        Not provided
                      </Text>
                    )}
                  </View>
